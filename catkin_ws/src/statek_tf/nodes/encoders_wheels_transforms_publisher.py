...
rospy.Subscriber("/" + statek_name + "/real_time/motors/left/encoder", Encoder, encoder_callback, ("left", statek_name))
rospy.Subscriber("/" + statek_name + "/real_time/motors/right/encoder", Encoder, encoder_callback, ("right", statek_name))
