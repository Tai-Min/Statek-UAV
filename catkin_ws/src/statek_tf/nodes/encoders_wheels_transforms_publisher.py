...
rospy.Subscriber("/" + statek_name + "/encoder_filtered_left", Encoder, encoder_callback, ("left", statek_name))
rospy.Subscriber("/" + statek_name + "/encoder_filtered_right", Encoder, encoder_callback, ("right", statek_name))
